...
const About = () => {
 ...
 <div id='about' className='grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2 lg:h-[100vh]'>
  ...
  <div className='bg-about bg-center bg-cover h-[100vh] lg:h-[100vh]'>
      ...
      <div className='text-center py-44 2xl:pt-[500px] kobus:pt-80 pc:pt-48'>
        ...
        <div className='h-[5px] w-[60px] bg-black m-auto '>
                 ...
                 <p className='w-[180px] h-[190px] text-[10px] font-light  text-justify sm:w-[680px] sm:text-xl lg:w-[440px]  2xl:w-[900px] 2xl:text-4xl kobus:pt-3 kobus:w-[900px] pc:w-[700px] pc:text-[20px]'>
